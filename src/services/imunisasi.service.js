...
export const getImunisasiById = async (id, user) => {
  ...
  await ensurePelayananDetailAccess(
    ...
    "Anda tidak memiliki akses ke data imunisasi desa lain",
  );
...
export const createImunisasi = async (payload, user) => {
  ...
  ensurePelayananMutationAccess(user, "membuat data imunisasi");
...
export const updateImunisasi = async (id, payload, user) => {
  ...
  ensurePelayananMutationAccess(user, "mengubah data imunisasi");
...
export const deleteImunisasi = async (id, user) => {
  ensurePelayananMutationAccess(user, "menghapus data imunisasi");
